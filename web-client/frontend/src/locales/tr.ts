...
export const tr = {
  ...
  "config.group_memory": "Hafıza",
  "config.group_memory_description":
    "Konsolidasyon, anıları kullanıma göre katmanlar arasında taşır: sık hatırlanan short anılar seasonal'a, seasonal anılar deep'e terfi eder; uzun süre hatırlanmayan seasonal anılar arşive taşınır, az hatırlanan eski short anılar silinir. Deep anılara otomatik dokunulmaz. Erişim, Rona'nın kendi aramasında ilk N sonuç arasında çıkmaktır ve aynı anı bekleme süresi içinde bir kez sayılır. Aralık 0 otomatik çalışmayı kapatır. Değişiklikler sunucu yeniden başlatılınca geçerli olur.",
  ...
  "data.no_archive": "Arşiv boş.",
  "data.action_archive": "Arşivle",
  "data.action_restore": "Hafızaya geri yükle (deep)",
  "data.memory_hits": "Bu katmanda {hits} erişim · toplam {total}",
  "data.last_access": "Son erişim: {date}",
  "data.never_accessed": "Henüz hatırlanmadı",
  "data.previous_layer": "Önceki katman: {layer}",
  "data.archived_at": "Arşivlenme: {date}",
  "data.archive_reason_auto": "Otomatik",
  "data.archive_reason_manual": "Elle",
  "data.archive_reason_person_deleted": "Kişi silindi",
  "data.delete_note_title": "Not silinsin mi?",
  "data.delete_note_description": "“{title}” kalıcı olarak silinecek.",
  "data.delete_person_title": "Kişi silinsin mi?",
  "data.delete_person_description": "{name} silinecek. Bu kişiye bağlı anılar arşive taşınacak.",
  "data.person_deleted_archived": "{count} bağlı anı arşive taşındı.",
  "data.delete_memory_title": "Anı silinsin mi?",
  "data.delete_memory_description": "Bu anı kalıcı olarak silinecek. İleride geri isteyebilirsen silmek yerine arşivle.",
  "data.delete_archived_title": "Arşiv kaydı silinsin mi?",
  "data.delete_archived_description": "Bu kayıt kalıcı olarak silinecek ve geri yüklenemeyecek.",
