...
export const tr = {
  ...
  "connections.no_packages": "Kurulu isteğe bağlı araç paketi yok.",
  ...
  "connections.backend_restarting": "Arka uç yeniden başlıyor, veriler güncel olmayabilir",

  // -- dashboard/ConnectionsPanel.tsx: Kurulu | Katalog sekmeleri, kur/güncelle/kaldır --
  "connections.tab_installed": "Kurulu",
  "connections.tab_catalog": "Katalog",
  "connections.browse_catalog": "Kataloğa göz at",
  "connections.catalog_loading": "Katalog yükleniyor...",
  "connections.catalog_error": "Katalog okunamadı",
  "connections.catalog_empty": "Katalogda paket yok.",
  "connections.catalog_refresh": "Yenile",
  "connections.requires": "gerektirir",
  "connections.dependents": "Bağımlı paketler:",
  "connections.requirement_problem": "sürüm sorunu: {detail}",
  "connections.install": "Kur",
  "connections.update": "Güncelle",
  "connections.uninstall": "Kaldır",
  "connections.preparing": "Hazırlanıyor...",
  "connections.installed_badge": "kurulu",
  "connections.update_badge": "{from} → {to} güncellemesi var",
  "connections.plan_title_install": "{id} kur",
  "connections.plan_title_update": "{id} güncelle",
  "connections.plan_dependency": "+ {id} {version} (bağımlılık)",
  "connections.plan_upgrade": "↑ {id} {from} → {to}",
  "connections.plan_incomplete": "Bu işlem tam tamamlanamayabilir; eksik adımlar kalabilir.",
  "connections.plan_note": "Zorunlu ayarlar kurulumdan sonra sorulacak.",
  "connections.uninstall_title": "{id} kaldırılsın mı?",
  "connections.uninstall_blocked": "Bu paketler ona bağımlı olduğu için önce onlar kaldırılmalı.",
  "connections.uninstall_purge": "Kullanıcı verilerini de sil (token, oturum vb.)",
  "connections.job_title_install": "Kurulum: {id}",
  "connections.job_title_update": "Güncelleme: {id}",
  "connections.job_title_uninstall": "Kaldırma: {id}",
  "connections.job_running": "çalışıyor",
  "connections.job_succeeded": "tamamlandı",
  "connections.job_failed": "başarısız",
  "connections.job_close": "Kapat",
  "connections.job_config_pending": "Yapılandırma bekleyen paketler: {ids}",
  "connections.job_reloading": "Backend paketleri yeniden yüklüyor...",
  "connections.job_reload_failed": "Paketler otomatik yeniden yüklenemedi; backend'i yeniden başlatın.",
  "connections.job_unhealthy": "{id}: sağlıksız — {detail}",
  ...
  "settings.section_prompts": "Promptlar",
  ...
  "prompts.group_main": "Ana sohbet",
  "prompts.group_subagent": "Arka plan ajanı",
  "prompts.group_trigger": "Zamanlanmış görev",
  "prompts.name_persona": "Kimlik ve davranış",
  "prompts.description_persona":
    "Rona'nın kim olduğunu, üslubunu ve genel davranış kurallarını tanımlar.",
  "prompts.name_output_text": "Metin çıktı biçimi",
  "prompts.description_output_text":
    "Yanıtların sesli değil metin olarak okunduğu sohbetlerde biçimlendirme kuralları.",
  "prompts.name_user": "Kullanıcı profili",
  "prompts.description_user":
    "Rona'nın konuştuğu kişi hakkında arka plan bilgisi (isim, tercihler vb.).",
  "prompts.name_toolbox": "Araç kullanımı",
  "prompts.description_toolbox": "Araçların ne zaman ve nasıl kullanılacağına dair genel kurallar.",
  "prompts.name_memory": "Hafıza kuralları",
  "prompts.description_memory":
    "Uzun süreli hafızaya ne zaman yazılacağı ve nasıl aranacağına dair kurallar.",
  "prompts.name_subagents": "Arka plan ajanı rehberi",
  "prompts.description_subagents":
    "Rona'nın işleri arka plan ajanlarına ne zaman ve nasıl devredeceğine dair rehber.",
  "prompts.name_trigger": "Zamanlanmış görev rehberi",
  "prompts.description_trigger": "Rona'nın zamanlanmış görevleri nasıl oluşturacağına dair rehber.",
  "prompts.name_subagent_worker": "Arka plan ajanı sistem promptu",
  "prompts.description_subagent_worker":
    "Arka planda çalışan ajanın kendi görevini nasıl yürüteceğini tanımlayan sistem promptu.",
  "prompts.name_trigger_worker": "Zamanlanmış görev sistem promptu",
  "prompts.description_trigger_worker":
    "Zamanlanmış görev tetiklendiğinde çalışan ajanın sistem promptu; sonucu JSON olarak döndürür.",
  "prompts.customized_badge": "özelleştirildi",
  "prompts.default_changed_badge": "varsayılan güncellendi",
  "prompts.updated_at": "{date} tarihinde güncellendi",
  "prompts.back_to_list": "Promptlara dön",
  "prompts.editor_label": "Prompt içeriği",
  "prompts.byte_count": "{count} / {max} bayt",
  "prompts.over_limit": "Boyut sınırını aşıyor",
  "prompts.placeholders_title": "Yer tutucular (eklemek için tıkla)",
  "prompts.draft_restored": "Kaydedilmemiş taslağın geri yüklendi.",
  "prompts.worker_note": "Bu prompt kullanıcıya değil, arka planda çalışan ajana talimat verir.",
  "prompts.trigger_worker_contract_note":
    "Bu prompt, sonucu JSON formatında (outcome ve condition_not_met alanlarıyla) döndürmelidir. Bu formatı bozarsan zamanlanmış görevler çalışmaz hale gelebilir.",
  "prompts.effective_next_message":
    "Değişiklik bir sonraki mesajdan itibaren geçerli olur, yeniden başlatma gerekmez.",
  "prompts.show_default": "Varsayılanı göster",
  "prompts.hide_default": "Varsayılanı gizle",
  "prompts.copy_default_to_editor": "Düzenleyiciye kopyala",
  "prompts.reset_to_default": "Varsayılana dön",
  "prompts.conflict_message": "Bu prompt sen düzenlerken başka bir yerden değiştirildi.",
  "prompts.load_server_version": "Sunucudaki sürümü yükle",
  "prompts.confirm_reset_title": "Varsayılana dönülsün mü?",
  "prompts.confirm_reset_description":
    "Özelleştirmen silinecek ve varsayılan prompt kullanılacak. Bu işlem geri alınamaz.",
  "prompts.confirm_discard_title": "Kaydedilmemiş değişiklikler var",
  "prompts.confirm_discard_description": "Kaydetmeden çıkarsan değişikliklerin kaybolur.",
  "prompts.discard_and_back": "Değişiklikleri at ve dön",
