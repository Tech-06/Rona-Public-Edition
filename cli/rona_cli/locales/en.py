...
STRINGS: dict[str, str] = {
    ...
    "tools.help_update": "Update a tool package",
    ...
    "tools.help_defer_config_flag": "defer required configuration (the package installs unconfigured)",
    ...
    "tools.update_marker": "installed {installed} → {version} available",
    "tools.update_hint": "To update: rona tools update <package>",
    ...
    "prompt.help_group": "Edit system prompts",
    "prompt.help_list": "List editable prompts",
    "prompt.help_show": "Show a prompt's content",
    "prompt.help_default_flag": "show the default content",
    "prompt.help_edit": "Open a prompt in your editor and save it",
    "prompt.help_file_flag": "take the content from this file (no editor opens)",
    "prompt.help_reset": "Revert a prompt to its default",
    "prompt.list_empty": "No prompts.",
    "prompt.customized_marker": "[customized]",
    "prompt.default_changed_marker": "[default updated]",
    "prompt.no_changes": "No changes.",
    "prompt.saved": "Saved; effective from the next message (no restart needed).",
    "prompt.reset_done": "'{id}' reverted to its default.",
    "prompt.confirm_reset": "Revert '{id}' to its default?",
    "prompt.conflict": "The version on the server has changed; fetch the current content first (`rona edit prompt show`).",
    "prompt.kept_draft": "Your changes were kept in: {path}",
}
