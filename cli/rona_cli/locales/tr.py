...
STRINGS: dict[str, str] = {
    ...
    "tools.help_update": "Bir araç paketini güncelle",
    ...
    "tools.help_defer_config_flag": "zorunlu yapılandırmayı sonraya bırak (paket yapılandırılmadan kurulur)",
    ...
    "tools.update_marker": "kurulu {installed} → {version} güncellemesi var",
    "tools.update_hint": "Güncellemek için: rona tools update <paket>",
    ...
    # -- commands/edit/prompt.py (new) ----------------------------------------------
    "prompt.help_group": "Sistem promptlarını düzenle",
    "prompt.help_list": "Düzenlenebilir promptları listele",
    "prompt.help_show": "Bir promptun içeriğini göster",
    "prompt.help_default_flag": "varsayılan içeriği göster",
    "prompt.help_edit": "Bir promptu düzenleyicide aç ve kaydet",
    "prompt.help_file_flag": "içeriği bu dosyadan al (düzenleyici açılmaz)",
    "prompt.help_reset": "Bir promptu varsayılana döndür",
    "prompt.list_empty": "Prompt yok.",
    "prompt.customized_marker": "[özelleştirildi]",
    "prompt.default_changed_marker": "[varsayılan güncellendi]",
    "prompt.no_changes": "Değişiklik yok.",
    "prompt.saved": "Kaydedildi; bir sonraki mesajdan itibaren geçerli (yeniden başlatma gerekmez).",
    "prompt.reset_done": "'{id}' varsayılana döndürüldü.",
    "prompt.confirm_reset": "'{id}' varsayılana döndürülsün mü?",
    "prompt.conflict": "Sunucudaki sürüm değişmiş; önce güncel içeriği al (`rona edit prompt show`).",
    "prompt.kept_draft": "Değişikliklerin saklandığı dosya: {path}",
}
